...
As conda cannot install this package.

"""

import numpy as np, miniball, math, cv2, matplotlib.pyplot as plt,scipy.ndimage

wd="O:/Tech_ECOS-OWF-Screening/Fugle-flagermus-havpattedyr/BIRDS/Ship_BasedSurveys/VerticalRadar/ScreenDumps/2023 08 10-16/"

# Load the image
image = cv2.imread(wd+"CAP_20230810_215849_287.jpg")
